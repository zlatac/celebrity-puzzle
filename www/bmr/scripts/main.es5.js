        ...
        locationPerimeter(latitude, longitude, distance) {
            ...
            function filterClubs() {
                return clubsArray.filter(item => {
                    ...
                    item.distance = distanceFromDj(mylocation.lat, mylocation.long, item.lat, item.long);return item;
                }).sort((a, b) => {
...
const routes = [{ path: '/request', component: spotify }, { path: '/dj', component: djSpotify }, { path: '/', component: landing }, { path: '/home', component: home }, { path: '*', redirect: '/' }];
